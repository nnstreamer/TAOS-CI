...
# @brief [MODULE] ${BOT_NAME}/pr-prebuild-misspelling
function pr-prebuild-misspelling(){
echo "########################################################################################"
echo "[MODULE] ${BOT_NAME}/pr-prebuild-misspelling: Check a misspelled statement in a document file with GNU Aspell"
