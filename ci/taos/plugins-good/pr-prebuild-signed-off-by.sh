...
# @brief [MODULE] TAOS/pr-prebuild-signed-off-by
function pr-prebuild-signed-off-by(){
    echo "########################################################################################"
    echo "[MODULE] TAOS/pr-prebuild-signed-off-by: Check the commit message body"
    ...
    if [[ $check_result == "success" ]]; then
        ...
        cibot_report $TOKEN "success" "TAOS/pr-prebuild-signed-off-by" "$message" "$REPOSITORY_WEB/pull/$input_pr/commits/$input_commit" "$GITHUB_WEBHOOK_API/statuses/$input_commit"
        ...
        cibot_report $TOKEN "failure" "TAOS/pr-prebuild-signed-off-by" "$message" "$REPOSITORY_WEB/pull/$input_pr/commits/$input_commit" "${GITHUB_WEBHOOK_API}/statuses/$input_commit"
        ...
        cibot_report $TOKEN "error" "TAOS/pr-prebuild-signed-off-by" "$message" "$REPOSITORY_WEB/pull/$input_pr/commits/$input_commit" "$GITHUB_WEBHOOK_API/statuses/$input_commit"
    fi
}
